...
→ See [CLAUDE.md](./CLAUDE.md) for full project context · [BUSINESS_RULES.md](./docs/reference/BUSINESS_RULES.md) for rules and flow · [TECH_STACK.md](./docs/reference/TECH_STACK.md) for stack details
